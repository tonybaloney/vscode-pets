...
const vscode_pets_1 = require("../common/vscode-pets");
...
function petPanelApp(basePetUri, petColor, scaleSize, petType) {
    ...
    var petLeft = 0;
    var petBottom = 0;
    if (scaleSize === vscode_pets_1.PetSize.nano) {
        var spriteWidth = 30, radius = 2;
    }
    else if (scaleSize === vscode_pets_1.PetSize.medium) {
        var spriteWidth = 55, radius = 4;
    }
    else if (scaleSize === vscode_pets_1.PetSize.large) {
    ...
    function startAnimations() {
        ...
        if (petType === vscode_pets_1.PetType.cat) {
            setInterval(() => {
                catSequence();
            }, 100);
        }
        else if (petType === vscode_pets_1.PetType.dog) {
            setInterval(() => {
                dogSequence();
            }, 100);
        }
        else if (petType === vscode_pets_1.PetType.snake) {
            setInterval(() => {
                snakeSequence();
            }, 100);
        }
        else if (petType === vscode_pets_1.PetType.clippy) {
            setInterval(() => {
                clippySequence();
            }, 100);
        }
